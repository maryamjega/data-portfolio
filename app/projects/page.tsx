      ...
      <section className="hero" id="overview">
        ...
        <div className="hero-left">
          ...
          <p className="hero-desc">
           A data-driven supply chain project using machine learning to forecast product demand and translate predictions into inventory decisions, helping reduce stockouts, excess inventory, and inefficient replenishment.
          </p>
