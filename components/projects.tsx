...
const cardData = [
  {
    ...
    highlights: [
      ...
      "Built and evaluated predictive models to improve forecast accuracy",
      "Visualised forecasting results to support inventory and operational planning",
    ],
    chips: ["Python", "Machine Learning", "Forecasting"],
    slug: "advanced-supply-chain-forecasting",
    featured: true,
  },
  {
    num: "02",
  ...
  },
  {
    ...
    desc: "SQL-based analysis of the Olist e-commerce dataset, exploring sales performance, customer behaviour, delivery trends, and marketplace activity.",
    highlights: [
      "Queried relational e-commerce data across customers, orders, products, sellers, and payments",
      "Analysed revenue, order volume, delivery performance, and customer purchasing patterns",
      "Translated SQL findings into clear business insights and recommendations",
    ],
    chips: ["PostgreSQL", "SQL", "Data Analysis"],
